<template>
  <div class="admin-layout min-h-screen bg-neutral-50">
    ...
    <!-- 侧边栏 -->
    <div :class="`bg-white text-neutral-800 min-h-screen fixed z-30 transition-all duration-300 shadow-xl ${isSidebarOpen ? 'left-0' : '-left-64'} md:left-0 w-64 border-r border-neutral-200`">
      <!-- 桌面端Logo -->
      ...
      <nav class="mt-6 px-3">
        ...
        <div class="mt-8 pt-6 border-t border-neutral-100">
          <router-link 
            ...
            @click="closeSidebarOnMobile"
          >
            <svg class="w-5 h-5 mr-3 text-neutral-400 group-hover:text-primary-400 transition-colors" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M9.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L9 12.586V5a1 1 0 012 0v7.586l2.293-2.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
            </svg>
            返回前台
          </router-link>
