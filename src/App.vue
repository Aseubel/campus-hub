    ...
    <header class="bg-white border-b border-neutral-200 shadow-sm sticky top-0 z-50">
      <div class="container mx-auto px-4 md:px-6 py-3 flex justify-between items-center">
        ...
        <router-link to="/" class="flex items-center space-x-3 group">
          <div class="w-8 h-8 bg-primary-600 rounded-xl flex items-center justify-center transition-transform group-hover:scale-105">
            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zM9 6a1 1 0 000 2h2a1 1 0 100-2H9zm0 4a1 1 0 000 2h6a1 1 0 100-2H9z" clip-rule="evenodd" />
            </svg>
          </div>
      ...
      <div class="container mx-auto px-4 md:px-6 py-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div class="flex items-center space-x-4">
            <span class="text-xs text-neutral-500">© 2024 CampusHub. All rights reserved.</span>
